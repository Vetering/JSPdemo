...
<%
    ...
    if (session1 == null || (!"2".equals(attributeValue != null ? attributeValue.toString() : null))) {
        // 如果未登录，弹出警告消息
%>
            ...
            <el-aside width="15%" style="background-color: rgb(238, 241, 246);height: 100%;">
                <el-menu  :default-openeds="['1', '3']">
                    <el-submenu index="1">
                        ...
                        <el-menu-item  index="2-1" @click="handleClassAll">{{this._class}}</el-menu-item>
                    </el-submenu>
                </el-menu>
            </el-aside>
            <el-container>
...
<script>
    new Vue({
        ...
        methods: {
            teacher() {
                ...
                axios.get('/api/TeacherServlet', {
                    ...
                    .then(response => {
                        ...
                        this._class = lastItem && lastItem.data && lastItem.data._class;
                        console.log("this._class:"+this._class)
                        this.load()
                    })
                    .catch(error => {
                        // 处理请求失败的逻辑
            ...
            exportData(){
                window.open(`/api/ExportClassServlet?_class=`+this._class);
            },
            ...
            handleSelect() {
                console.log("handleSelect:"+ this.total)
