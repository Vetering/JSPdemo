...
<%
    ...
    if (session1 == null || !"1".equals(attributeValue != null ? attributeValue.toString() : null)) {
        // 如果未登录，弹出警告消息
%>
    ...
    <div id="app" style="">
        <el-container style="height: 100%; border: 1px solid #eee;">
            <el-aside width="15%" style="background-color: rgb(238, 241, 246);height: 100%;">
                <%--                :default-openeds="['1', '3']"--%>
                    <el-menu>
                        <el-submenu v-for="(classData, index) in classDataList" :key="index" :index="`${index + 1}`">
                            <template slot="title"><i class="el-icon-message"></i>{{ classData.title }}</template>
                            <el-menu-item v-for="(classItem, i) in classData.items" :key="i" :index="`${index + 1}-${i + 1}`" @click="handleClass(index, i)">
                                {{ classItem }}
                            </el-menu-item>
                        </el-submenu>
                    </el-menu>
                ...
                <el-header style="text-align: right; font-size: 12px;border-radius: 5px; background-color: white;	border-bottom-style:solid;border-width:1px;">
                    ...
                    <div class="top-nav-right"><el-dropdown>
                        ...
                        <el-dropdown-menu slot="dropdown">
                            <el-dropdown-item><el-button style="border: none" @click="Quit">退出登录</el-button></el-dropdown-item>
...
<script>
    new Vue({
        ...
        data() {
            return {
                classDataList: [
                    { title: '计算机应用技术', items: ['计算机应用技术一班', '计算机应用技术二班', '计算机应用技术三班', '计算机应用技术四班', '计算机应用技术五班', '六班'] },
                    { title: '大数据技术', items: ['大数据技术一班', '大数据技术二班', '大数据技术三班', '大数据技术四班', '大数据技术五班', '大数据技术六班'] },
                    { title: '数字媒体技术', items: ['数字媒体技术一班', '数字媒体技术二班', '数字媒体技术三班', '数字媒体技术四班', '数字媒体技术五班', '数字媒体技术六班'] },
                    { title: 'VR数字媒体技术', items: ['VR数字媒体技术一班', 'VR数字媒体技术二班', 'VR数字媒体技术三班', 'VR数字媒体技术四班', 'VR数字媒体技术五班', 'VR数字媒体技术六班'] },
        ...
        methods: {
            handleClass(index, classIndex) {
                const _class = this.classDataList[index].items[classIndex];
                axios.get('/api/DataForwardServlet', {
                    params: {
                        _class,
                    },
                }).then(response => {
            ...
            Quit(){
                window.location.href ='/api/LogoutServlet';
            },
